...
export default function TextilePage() {
  ...
  useEffect(() => {
    ...
    const ctx = fadeUp(".animate-textile");
    return () => ctx.revert();
  }, [t]);
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[40vh] min-h-[350px] flex items-center justify-center overflow-hidden bg-[#0f1f3f]">
        <div className="absolute inset-0 opacity-40">
          <Image 
            ...
            alt="Eser Holding Textile Sector" 
            fill 
        ...
        <div className="animate-textile relative z-10 text-center px-4">
      ...
      <section className="w-full py-20 md:py-32">
        <div className="animate-textile container-custom">
