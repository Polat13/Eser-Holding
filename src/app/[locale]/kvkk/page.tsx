  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[30vh] min-h-[280px] flex items-center justify-center overflow-hidden bg-[#0f1f3f]">
        ...
        <div className="animate-kvkk relative z-10 text-center px-4">
      ...
      <section className="w-full py-20 md:py-32">
        <div className="animate-kvkk container-custom max-w-4xl mx-auto">
          ...
          <div className="flex flex-col gap-12 text-lg text-gray-700 font-light leading-relaxed">
            ...
            {/* Bölüm 7 */}
            <div>
              <h2 className="text-2xl font-semibold text-[#1E3A8A] mb-4">{t("section7Title")}</h2>
              <p>{t("section7Text")}</p>
            </div>
