...
import { fadeUp } from "@/animations/fadeUp"; // Animasyon dosyasının yolu

export default function VisionPage() {
  const t = useTranslations("Vision");

  useEffect(() => {
    const ctx = fadeUp(".animate-vision");
    return () => ctx.revert();
  }, [t]);
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative w-full h-[40vh] min-h-[350px] flex items-center justify-center overflow-hidden bg-[#0f1f3f]">
        <div className="absolute inset-0 opacity-30">
          <Image 
            src="/images/vizyon.jpg" 
            alt="Eser Holding Vision" 
            fill 
        ...
        <div className="animate-vision relative z-10 text-center px-4">
      ...
      <section className="w-full py-20 md:py-32">
        <div className="animate-vision container-custom">
