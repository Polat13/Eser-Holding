  ...
  return (
    <section className="relative w-full h-screen flex items-center overflow-hidden">
      ...
      <video
        ...
        src="https://cdn.pixabay.com/video/2024/03/31/206315_large.mp4" 
      />

      {/* --- KRİTİK DEĞİŞİKLİK BURADA --- 
        Mobilde: bg-black/60 (Tüm ekranı %60 siyah yapar, yazılar kesin okunur)
        Masaüstünde (md:): Siyahlığı sıfırlar ve soldan sağa şık degradeyi uygular
      */}
      ...
      {/* İçerik Konteynerine "drop-shadow-2xl" ekledik. Yazıların arkasına görünmez bir gölge atar */}
      <div 
        className="container-custom relative z-10 flex flex-col gap-6 md:gap-8 drop-shadow-2xl" 
        ref={heroRef}
      >
        
        {/* Mobilde text-4xl yapıp biraz küçülttük ki ekrana daha iyi sığsın */}
        <h1 className="text-4xl sm:text-7xl md:text-[5rem] font-medium text-white max-w-4xl leading-[1.15] tracking-tight">
          Sürdürülebilir Yarınlara Doğru
        </h1>
        
        <p className="text-base sm:text-lg md:text-xl text-gray-100 max-w-xl font-light leading-relaxed">
